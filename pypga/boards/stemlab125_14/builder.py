...
from pypga.core.migen import MigenModule
...
class StemlabBuilder:
    _build_dir = "build"
    _build_results = ["top.bin", "csr.csv"]
    ...
    def _create_platform(self):
        ...
        self._platform.toolchain.additional_commands.extend([
            "write_cfgmem -force -format BIN -size 2 -interface SMAPx32 -disablebitswap -loadbit \"up 0x0 ./top.bit\" ./redpitaya.bin",
        ])

...
class Adc(Module):
    in1: FixedPointRegister.custom(width=bits, signed=True, decimals=bits-1, readonly=True, default=0)
    in2: FixedPointRegister.custom(width=bits, signed=True, decimals=bits-1, readonly=True, default=0)

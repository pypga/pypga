from pypga.core import Module, logic, Register, BoolRegister, TriggerRegister
from .migen.counter import MigenCounter


def Counter(width=32, default_start=0, default_stop=None, default_step=1, default_on=True, direction="up"):

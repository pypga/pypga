...
from migen import Case, Cat, Constant, Record
from misoc.cores.spi2 import SPIInterface, SPIMaster, SPIMachine
...
class MigenSPI(MigenModule):
    ...
    def __init__(
        ...
        self.sync += self.spi.length.eq(data_width),
        ...
        self.comb += [
            ...
            self.cs.eq(self.spi.cs_next ^ cs_polarity),

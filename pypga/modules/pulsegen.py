from pypga.core import BoolRegister, Module, NumberRegister, logic
...
def PulseGen(default_period=8, default_on=True, high_after_on=True, period_width=32):
    class _PulseGen(Module):
        period: NumberRegister(
            width=period_width, default=default_period - 2, offset_from_python=-2, min=2
        )
